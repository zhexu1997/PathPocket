...
# Relation hyperedge IoU on graph hits only before vector ∩ (operate._filter_graph_relations_by_entity_iou;
# structured mix uses _merge_graph_relations_branch_iou per morph/marker list)
DEFAULT_RELATION_ENTITY_IOU_THRESHOLD = 0.1
