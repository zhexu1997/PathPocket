...
# Note: Optional[str] syntax requires Python 3.10+, using Optional[str] for compatibility

from pathpocket.exceptions import PipelineNotInitializedError
...
def direct_log(message, enable_output: bool = True, level: str = "DEBUG"):
    ...
    # Get the current logger level from the pathpocket logger
    try:
...
pathpocket_init_pipeline_status = initialize_pipeline_status
pathpocket_init_share_data = initialize_share_data
pathpocket_set_default_workspace = set_default_workspace
